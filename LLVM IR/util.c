...
allocateTreeNode(void)
{
  ...
  if (t == NULL)
  ...
  else
    {
      t->sibling = NULL;
      t->lineno = lineno;
	  t->Alloca = NULL;//builder.CreateAlloca(T32);
	  t->Load = NULL;
    }
                            ...
                            TreeNode *right_expression)
{
  ...
  if (t != NULL)
	...
	//  t->attr.cmpExpr.compareResAlloca = builder.CreateAlloca(T32);
    }
                          ...
                          TreeNode *right_expression)
{
  ...
  if (t != NULL)
	...
	//  t->attr.addExpr.additiveResAlloca = builder.CreateAlloca(T32);
    }
                                ...
                                TreeNode *right_expression)
{
  ...
  if (t != NULL)
	...
	//  t->attr.multExpr.multiResAlloca = builder.CreateAlloca(T32);
    }
